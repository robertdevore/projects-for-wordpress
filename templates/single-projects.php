...
<div class="project-single-container">
    <div class="project-header">
        <div class="project-banner">
            ...
            <?php else : ?>
                <img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . 'assets/images/placeholder-banner.jpg' ); ?>" alt="<?php esc_attr_e( 'Project Banner', 'projects-for-wordpress' ); ?>">
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="project-main-content">
        ...
        <div class="project-sidebar">
            <div class="project-buttons">
                ...
                <?php else : ?>
                    <p><?php esc_html_e( 'GitHub Repository:', 'projects-for-wordpress' ); ?> <?php esc_html_e( 'No repository linked.', 'projects-for-wordpress' ); ?></p>
                <?php endif; ?>
            </div>
            ...
            <?php if ( $owner_avatar && $owner_name ) : ?>
                <div class="project-owner">
                    ...
                    <p>
                        <strong><?php esc_html_e( 'Owner:', 'projects-for-wordpress' ); ?></strong>
            ...
            <div class="project-meta">
                <table class="project-meta-table">
                    <tbody>
                        <tr>
                            <th><?php esc_html_e( 'Version:', 'projects-for-wordpress' ); ?></th>
                            <td><?php echo esc_html( $version ); ?></td>
                        </tr>
                        <?php if ( $last_updated ) : ?>
                            <tr>
                                <th><?php esc_html_e( 'Updated:', 'projects-for-wordpress' ); ?></th>
                                <td><?php echo esc_html( $last_updated ); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if ( $license ) : ?>
                            <tr>
                                <th><?php esc_html_e( 'License:', 'projects-for-wordpress' ); ?></th>
                                <td><?php echo esc_html( $license ); ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php if ( $language ) : ?>
                            <tr>
                                <th><?php esc_html_e( 'Language:', 'projects-for-wordpress' ); ?></th>
                                <td><?php echo esc_html( $language ); ?></td>
                            </tr>
                        <?php endif; ?>
                        <tr>
                            <th><?php esc_html_e( 'Downloads:', 'projects-for-wordpress' ); ?></th>
